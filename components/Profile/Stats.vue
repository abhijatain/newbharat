...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <!-- Grid -->
  <div class="grid items-center  gap-6 lg:gap-12">
    <div class="lg:col-span-4">
      ...
      <div class="lg:pe-6 xl:pe-12">
        ...
        <p class="mt-2 sm:mt-3 text-gray-500 dark:text-neutral-500">Days visited</p>
      </div>
      <!-- End Stats -->
    </div>
    <!-- End Col -->
    ...
    <div class="lg:col-span-8 relative lg:before:absolute lg:before:top-0 lg:before:-start-12 lg:before:w-px lg:before:h-full lg:before:bg-gray-200 lg:before:dark:bg-neutral-700">
      <div class="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-3 sm:gap-8">
        <!-- Stats -->
        <div>
          <p class="text-3xl font-semibold text-blue-600">852</p>
          <p class="mt-1 text-gray-500 dark:text-neutral-500">posts read</p>
        </div>
        <!-- End Stats -->

        <!-- Stats -->
        <div>
          <p class="text-3xl font-semibold text-blue-600">20</p>
          <p class="mt-1 text-gray-500 dark:text-neutral-500">topics created</p>
        </div>
        <!-- End Stats -->
        ...
        <div>
          ...
          <p class="mt-1 text-gray-500 dark:text-neutral-500">likes given</p>
        </div>
        <!-- End Stats -->
        <!-- Stats -->
        <div>
          <p class="text-3xl font-semibold text-blue-600">10</p>
          <p class="mt-1 text-gray-500 dark:text-neutral-500">likes received</p>
        </div>
        <!-- End Stats -->
      </div>
    </div>
