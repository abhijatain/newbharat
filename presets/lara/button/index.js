    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Danger Button
            {
                ...
                'bg-red-600 dark:bg-red-400': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
            ...
            { 'focus:ring-green-600/50 dark:focus:ring-green-300/50': props.severity === 'success' },
            // Text & Outlined Button
