export default {
    ...
    loadingoverlay: {
        class: [
            ...
            // Color
            'bg-surface-100/40 dark:bg-black/40',
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                (props.sortable === '' || props.sortable) && context.sorted ? 'dark:text-white dark:bg-primary-400/30' : 'dark:text-white/80 dark:bg-black',
                'border-surface-200 dark:border-surface-700 ',
        ...
        bodycell: ({ props, context, state, parent }) => ({
            class: [
                ...
                { 'bg-surface-0 dark:bg-black': parent.instance.frozenRow || props.frozen || props.frozen === '' },
        ...
        filterrowitem: ({ context }) => ({
            class: [
                ...
                { 'bg-surface-0 dark:bg-black text-surface-700 dark:text-white/80': !context?.highlighted },
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                'dark:text-white/70 dark:hover:text-white/80 dark:bg-black',
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            ...
            { 'bg-surface-0 text-surface-600 dark:bg-black': !context.selected },
            { 'font-bold bg-surface-0 dark:bg-black': props.frozenRow },
    ...
    rowexpansion: {
        class: 'bg-surface-0 dark:bg-black text-surface-600 dark:text-white/80'
    },
    rowgroupheader: {
        class: ['sticky z-20', 'bg-surface-0 text-surface-600 dark:text-white/70', 'dark:bg-black']
    },
    rowgroupfooter: {
        class: ['sticky z-20', 'bg-surface-0 text-surface-600 dark:text-white/70', 'dark:bg-black']
    },
