<template>
        <div class=" container mx-auto flex flex-col gap-4 lg:gap-8 md:p-6 ">
            <TopHeader />
            <div v-for="article in articles2" class="flex flex-col border-b bg-white    lg:flex-row lg:mx-3  dark:border-gray-700 dark:bg-black  ">
...
const { data: articles2 } = await useLazyFetch(`https://test-am3oxfhvvq-em.a.run.app/api/article/${route.params.id}`, {key:route.params.id})
